<template>
  <div>
    ...
    <div class="container">
      <h1 class="text-center">จัดการรายการซ่อม</h1>
      <br />
      <div class="text-center">
        <img src="@/assets/new.png" alt="suscess" width="40" height="40" />:แจ้งซ่อมใหม่ |
        <img src="@/assets/success.png" alt="suscess" width="50" height="45" />:ซ่อมเสร็จ |
                      ...
                      <v-row>
                        <v-col class="d-flex" cols="12" sm="6" md="4">
                          ...
                          <v-select
                            ...
                            item-text="name"
                            item-value="tncid"
                            v-model="editedItem.tnc"
                            
                          ></v-select>
                        </v-col>

                        <v-col cols="12" sm="6" md="4">
                          <v-text-field v-model="editedItem.status" readonly label="สถานะ"></v-text-field>
                        </v-col>

                        <v-col cols="12" sm="6" md="4">
                          <v-text-field v-model="editedItem.room" readonly label="ห้อง"></v-text-field>
                        </v-col>
                      </v-row>
                    </v-container>
                  </v-card-text>
  ...
  methods: {
    ...
    close() {
     ...
     rout(item) {
      ...
      this.editedItem = Object.assign({}, item);
      console.log(item.id);
      this.$router.push({ name: 'name1', params: { _id: item.id } });
